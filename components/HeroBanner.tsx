    ...
    >
      ...
      <div className="absolute right-8 top-1/2 -translate-y-1/2 flex gap-2">
        <input
          ...
          className="w-140 h-9.25 px-7 rounded-md bg-surface text-black-primary text-xs font-mono outline-none border border-black-primary  focus:border-primary transition-colors"
        />
