...
export const CARDS: CardDetail[] = [
  ...
  {
    id: "product009",
    title: "2000+ Font Collection Bundle 2026",
    thumbnail: "https://res.cloudinary.com/lbovk2lu/image/upload/v1788330128/bgthumb.svg",
    banner: "https://res.cloudinary.com/lbovk2lu/image/upload/v1788395088/Screenshot_2026-09-03_072159.png",
    ...
    updatedAt: "2026-08-01",
    description:
      "A curated collection of 2000++ high-readability monospace, bitmap, and pixel display typefaces crafted specifically for terminal interfaces, code editors, retro game UI, and modern developer documentation.",
    features: [
      "2000++ Handpicked retro monospace, pixel, and cyber display font families",
    ...
    downloadUrl: "https://www.mediafire.com/file/hex4c3p6h14io1x/fontColection2026.zip/file",
    donateUrl: "https://trakteer.id",
  },
  {
    id: "product010",
  ...
  {
    id: "product011",
    title: "Ardfry PSD Codec x64 v1.6.0",
    thumbnail: "https://res.cloudinary.com/lbovk2lu/image/upload/v1788330128/bgthumb.svg",
    banner: "https://res.cloudinary.com/lbovk2lu/image/upload/v1788327247/banner09348.jpg",
    icon: "https://res.cloudinary.com/lbovk2lu/image/upload/v1788396509/psdcodec.svg",
    badge: "free",
    categories: ["TOOLS"],
    version: "v1.6.0",
    fileSize: "1.3 MB",
  ...
  {
    id: "product018",
    title: "Sublime Text 4 build 4200 x64",
    thumbnail: "https://res.cloudinary.com/lbovk2lu/image/upload/v1788330128/bgthumb.svg",
    banner: "https://res.cloudinary.com/lbovk2lu/image/upload/v1788369095/sublimebanner.gif",
    icon: "https://res.cloudinary.com/lbovk2lu/image/upload/v1788368964/sublime.png",
    badge: "free",
    categories: ["TOOLS"],
    version: "v4.0.0",
    fileSize: "19,2 MB",
    ...
    description:
      "Sublime Text 4 is a fast, lightweight, and feature-rich text and code editor designed for maximum performance and efficiency. You can download installers for your system directly from the.",
    features: [
      "GPU Rendering: Utilizes your computer's graphics card for smooth UI rendering up to 8K resolutions while using less power.",
      "Context-Aware Auto Complete: Provides smart code completions by analyzing existing code in your active project.",
      "Tab Multi-Select: Lets you select multiple file tabs to view and edit files side-by-side effortlessly.",
      "Updated Language Support: Ships with built-in syntax definitions for TypeScript, JSX, TSX, TOML, and Zsh..",
      "Cross-Platform: Works seamlessly on Windows, Linux, and macOS with a consistent user experience.",
      "Fast, lightweight, and feature-rich text and code editor",
      "Refreshed UI: Supports auto dark-mode switching and custom title bars across major operating systems.",
    ],
    requirements: [
      "Sublime Text 4 Build 4200 x64",
      "Windows 10 or higher",
      "64-bit operating system",
    ],
    downloadUrl: "https://www.mediafire.com/file/g2dtq2gg0ke1soa/SublimeText4_Build_4200x64.zip/file",
    donateUrl: "https://trakteer.id",
  },
  {
    id: "product019",
    title: "MarkText v0.19.1 X64 .md Viewer",
    thumbnail: "https://res.cloudinary.com/lbovk2lu/image/upload/v1788330128/bgthumb.svg",
    banner: "https://res.cloudinary.com/lbovk2lu/image/upload/v1788371544/1620196013markdownlinux-marktext.webp",
    icon: "https://res.cloudinary.com/lbovk2lu/image/upload/v1788371169/marktext.png",
    badge: "free",
    categories: ["TOOLS"],
    version: "v0.19.1",
    fileSize: "105 MB",
    fileType: ".EXE",
    license: "Open Source",
    author: "MarkText Contributor",
    updatedAt: "2026-09-03",
    description:
      "MarkText is an open-source Markdown editor powered by the support of its community. If MarkText improves your workflow GitHub page link => https://github.com/marktext/marktext#download-and-installation.",
    ...
    requirements: [
      "Requires Windows 10 or 11. Both x64 and arm64 installers are published",
      "64-bit operating system",
    ],
    downloadUrl: "https://github.com/marktext/marktext/releases/download/v0.19.1/marktext-win-x64-0.19.1-setup.exe",
    donateUrl: "https://trakteer.id",
  },
];
