...
export const CARDS: CardDetail[] = [
  {
    ...
    icon: "https://res.cloudinary.com/lbovk2lu/image/upload/v1788288717/ImageOptim.png",
    badge: "free",
    categories: ["APPS"],
    version: "v1.02.00",
    fileSize: "18.4 MB",
  ...
  },
  {
    ...
    updatedAt: "2026-07-28",
    description:
      "CorelDRAW Graphics Suite 2026 is a professional design software release that introduces advanced AI tools, a refreshed interface, and significantly faster performance.\n\n" +
      "Key Features and Updates:\n\n" +
      "- Artist Intelligence AI: “Built to amplify artistry rather than replace it, CorelDRAW Graphics Suite 2026 introduces intelligent tools in CorelDRAW and Corel PHOTO-PAINT that accelerate ideation and improve your workflow.” -- CorelDRAW. This includes text-to-image generation, background removal, and object selection.\n\n" +
      "- Performance Boost: “App launch times up to three times faster or more” -- CorelDRAW. This allows for smoother project switching and improved stability during heavy workloads.\n\n" +
      "- Refreshed Interface: “A refreshed interface introduces updated icons, refined controls, clearer active-tool states, and more consistent navigation across desktop and browser-based workflows.” -- Yahoo Finance.\n\n" +
      "- New Assets: Includes over 200 cloud-based templates and pixel-based brush packs.",
    features: [
      "AI-Powered Symmetry",
  ...
  },
  {
    ...
    description:
      "psd codec x64 for windows explorer. View psd files in windows explorer.",
    features: [
      "psd codec x64",
